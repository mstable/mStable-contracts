...
contract IMasset is MassetStructs {
    ...
    /** @dev Minting */
    function mint(uint8 _basset, uint256 _bassetQuantity) external returns (uint256 massetMinted);
    function mintTo(uint8 _basset, uint256 _bassetQuantity, address _recipient) external returns (uint256 massetMinted);
    ...
    /** @dev Redeeming */
    function redeem(uint8 _basset,uint256 _bassetQuantity) external returns (uint256 massetRedeemed);
    function redeemTo(uint8 _basset, uint256 _bassetQuantity, address _recipient) external returns (uint256 massetRedeemed);
