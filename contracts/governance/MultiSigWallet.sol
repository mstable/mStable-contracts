...
contract MultiSigWallet {
     ...
     */
    modifier onlyWallet() {
        require(msg.sender == address(this), "Only wallet can exec");
        _;
    }
    ...
    modifier transactionExists(uint transactionId) {
        require(transactions[transactionId].destination != address(0), "Tx must exist");
        _;
    }
    ...
    modifier notExecuted(uint transactionId) {
        require(!transactions[transactionId].executed, "Must not be executed");
        _;
    }

    modifier notNull(address _address) {
        require(_address != address(0), "Must be non null addr");
        _;
    }
