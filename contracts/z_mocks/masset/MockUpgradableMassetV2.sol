...
// External
import { IForgeValidator } from "../../masset/forge-validator/IForgeValidator.sol";
...
/**
 * @dev MockUpgradableMassetV2 contract to use in beta-testing
 */
contract MockUpgradableMassetV2 is
    Initializable,
    IMasset,
    InitializableToken,
    InitializableModule,
    InitializableReentrancyGuard
{
    ...
    // *********************************************
    // CHANGED HERE: Add new variable
    // *********************************************
    string public version = "";
    uint256 private NEW_MAX_FEE = 0;

    // *********************************************
    // CHANGED HERE: Removed initialize() function
    // *********************************************

    // *********************************************
    // CHANGED HERE: New init() function
    // *********************************************
    ...
    ****************************************/
    ...
    // *********************************************
    // CHANGED HERE: Modify existing function
    // *********************************************
    ...
    function setSwapFee(uint256 _swapFee)
        ...
        onlyGovernor
    {
        revert("Removed from v2");
    }
    // *********************************************
    // CHANGED HERE: Added a new function
    // *********************************************
