...
/**
 * @title   RebasedFeederPool
 * @author  mStable, @stobiewan
* @notice  Base contract for Feeder Pools (fPools) handling rebased stable assets. Feeder Pools are combined of 50/50
*          fAsset and mAsset. This supports efficient swaps into and out of mAssets and the bAssets in the mAsset basket
*          (a.k.a mpAssets). There is 0 fee to trade from fAsset into mAsset, providing low cost on-ramps into mAssets.
 * @dev     VERSION: 1.0
 *          DATE:    2021-10-01
 */
contract RebasedFeederPool is
    IFeederPool,
    Initializable,
    InitializableToken,
    PausableModule,
    InitializableReentrancyGuard
{
    ...
    ****************************************/
    ...
    /**
     * @dev Get actual basset data with updated vault balance of fAsset if liquidity index changed.
     */
    ...
    ****************************************/
    ...
    /**
     * @dev Updates the vault balance of fAsset if liquidity index changed.
     */
