...
interface CompoundIntegrationInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "SkippedWithdrawal(address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "SkippedWithdrawal"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Withdrawal"): EventFragment;
}

export class CompoundIntegration extends BaseContract {
  ...
  interface: CompoundIntegrationInterface;
  ...
  filters: {
    ...
    SkippedWithdrawal(
      ...
      [string, BigNumber],
      { bAsset: string; amount: BigNumber }
    >;
