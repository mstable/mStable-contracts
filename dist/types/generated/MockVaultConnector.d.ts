...
interface MockVaultConnectorInterface extends ethers.utils.Interface {
  functions: {
...
export class MockVaultConnector extends BaseContract {
  ...
  interface: MockVaultConnectorInterface;
