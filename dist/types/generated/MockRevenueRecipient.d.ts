...
interface MockRevenueRecipientInterface extends ethers.utils.Interface {
  functions: {
...
export class MockRevenueRecipient extends BaseContract {
  ...
  interface: MockRevenueRecipientInterface;
