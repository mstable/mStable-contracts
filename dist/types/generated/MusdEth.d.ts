...
interface MusdEthInterface extends ethers.utils.Interface {
  functions: {
    ...
    "upgrade(address,tuple)": FunctionFragment;
...
export class MusdEth extends BaseContract {
  ...
  getConfig(
    ...
    [BigNumber, [BigNumber, BigNumber] & { min: BigNumber; max: BigNumber }] & {
      a: BigNumber;
      limits: [BigNumber, BigNumber] & { min: BigNumber; max: BigNumber };
    }
  >;
