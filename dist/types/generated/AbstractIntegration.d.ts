...
interface AbstractIntegrationInterface extends ethers.utils.Interface {
  functions: {
...
export class AbstractIntegration extends BaseContract {
  ...
  interface: AbstractIntegrationInterface;
