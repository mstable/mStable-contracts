...
interface MockMassetInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setAmountForCollectInterest(uint256)": FunctionFragment;
    "setAmountForPlatformInterest(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setAmountForCollectInterest",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setAmountForPlatformInterest",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class MockMasset extends BaseContract {
  ...
  functions: {
    ...
    setAmountForCollectInterest(
      _amount: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    setAmountForPlatformInterest(
      _amount: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
