...
interface MaliciousAaveIntegrationInterface extends ethers.utils.Interface {
  functions: {
...
export class MaliciousAaveIntegration extends BaseContract {
  ...
  interface: MaliciousAaveIntegrationInterface;
