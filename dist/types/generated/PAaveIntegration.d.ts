...
interface PAaveIntegrationInterface extends ethers.utils.Interface {
  functions: {
...
export class PAaveIntegration extends BaseContract {
  ...
  interface: PAaveIntegrationInterface;
