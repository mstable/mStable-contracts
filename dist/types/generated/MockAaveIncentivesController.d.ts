...
interface MockAaveIncentivesControllerInterface extends ethers.utils.Interface {
  functions: {
...
export class MockAaveIncentivesController extends BaseContract {
  ...
  interface: MockAaveIncentivesControllerInterface;
