...
interface ExposedMassetInterface extends ethers.utils.Interface {
  functions: {
    ...
    "simulateRedeemMasset(uint256,uint256[],uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "simulateRedeemMasset",
...
export class ExposedMasset extends BaseContract {
  ...
  interface: ExposedMassetInterface;
  ...
  functions: {
    ...
    getK(overrides?: CallOverrides): Promise<[BigNumber] & { k: BigNumber }>;
