...
interface MockErroneousConnector1Interface extends ethers.utils.Interface {
  functions: {
...
export class MockErroneousConnector1 extends BaseContract {
  ...
  interface: MockErroneousConnector1Interface;
