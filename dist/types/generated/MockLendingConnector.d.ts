...
interface MockLendingConnectorInterface extends ethers.utils.Interface {
  functions: {
...
export class MockLendingConnector extends BaseContract {
  ...
  interface: MockLendingConnectorInterface;
