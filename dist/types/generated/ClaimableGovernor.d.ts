...
interface ClaimableGovernorInterface extends ethers.utils.Interface {
  functions: {
...
export class ClaimableGovernor extends BaseContract {
  ...
  interface: ClaimableGovernorInterface;
