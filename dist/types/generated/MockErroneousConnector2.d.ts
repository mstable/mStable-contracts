...
interface MockErroneousConnector2Interface extends ethers.utils.Interface {
  functions: {
...
export class MockErroneousConnector2 extends BaseContract {
  ...
  interface: MockErroneousConnector2Interface;
